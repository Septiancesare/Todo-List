            ...
            <div class="p-4">
                ...
                <nav class="mt-8 flex flex-col space-y-1">
                    ...
                    <a href="{{ route('category.index') }}" 
                        class="flex items-center gap-3 p-3 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('category.*') ? 'bg-gray-200 dark:bg-gray-700 font-medium' : '' }}">
